...
public class DelayedAckEventBatchTimerTest {
    ...
    public void testHandleTimeOut() {
        ...
        delayedAckEventBatchTimer.handleTimeout(timer);
        when(
    ...
    public void testStartTimer() {
        ...
        final List<AlarmActionResponse> response = new ArrayList<AlarmActionResponse>();
        response.add(alarmActionResponse);
        delayedAckEventBatchTimer.startAlarmAckTimer(poIdSubBatches, 123L);
        when(timerService.createIntervalTimer(0, 4000L, new TimerConfig())).thenReturn(delayedAckEventTimer);
    }
}
